    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="goats">Caprinos</TabsTrigger>
        </TabsList>
        <TabsContent value="overview" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Total Caprinos</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card className="col-span-1">
              <CardHeader>
                ...
                <CardDescription>Distribución de caprinos por raza en la granja</CardDescription>
              </CardHeader>
        ...
        <TabsContent value="goats" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Nacimientos mensuales de caprinos</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
